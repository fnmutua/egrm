...
| AI (opt-in)        | Provider-adapter package (OpenAI/Azure/xAI/local via Ollama)                | [16-ai-integration.md](16-ai-integration.md) — CD-16, PII redaction, `ai_interaction` audit |
